            ...
            <div class="col-12">
                <x-card>
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto d-none d-lg-flex">
                                <a href="{{ route('proyectos.index') }}">
                                    <i class="far fa-arrow-alt-circle-left fa-2x" data-toggle="tooltip"
                                        title="Regresar"></i>
                                </a>
                            </div>
                    ...
                    <x-slot:body class="table-responsive p-0" style="height: 400px;">
                        <x-data-table
                            :headers="['#', 'Proyecto', 'Elemento', 'Modelo', 'Tipo de Cantidad', 'Cantidad', 'Acciones']">
                            ...
                            <tr>
                                ...
                                @if ($elemento->cantidad > 5 && $elemento->cantidad <= 10) <td><span
                                        class="badge badge-pill badge-warning">{{ $elemento->cantidad }}</span></td>
                                    @elseif ($elemento->cantidad <= 5) <td><span
                                            class="badge badge-pill badge-danger">{{ $elemento->cantidad }}</span></td>
                                        @else
                                        ...
                                        <td class="text-center">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-2">
                                                    <a
                                                        href="{{ route('proyectos.elementos.show', [$proyecto->id_proyecto, $elemento->id_elemento]) }}">
                                                        <i class="far fa-eye" data-toggle="tooltip"
                                                            title="Detalles Elemento"></i>
                                                    </a>
                                                </div>

                                                <div class="col-2">
                                                    <a href="{{ route('proyectos.elementos.edit', [$proyecto->id_proyecto, $elemento->id_elemento]) }}"
                                                        class="text-success">
                                                        <i class="far fa-edit" data-toggle="tooltip"
                                                            title="Actualizar Elemento"></i>
                                                    </a>
                                                </div>
